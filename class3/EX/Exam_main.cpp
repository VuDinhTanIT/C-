...
int main()
{
    ...
    PassFailExam exam(questions, missed, minPassing);
     // GradedActivity *grade = new GradedActivity(88.2);
     // PassFailExam *pass = static_cast<PassFailExam *> (grade);
...
//    cout << fixed << setprecision(1);
//     cout << "\nEach question counts "
//          << pass-> getPointsEach() << " points.\n";
//     cout << "The minimum passing score is "
//          << pass ->getMinPassingScore() << endl;
//     cout << "The student's exam score is "
//          << pass ->getScore() << endl;
//     cout << "The student's grade is "
//          << pass->getLetterGrade() << endl;
    return 0;
}